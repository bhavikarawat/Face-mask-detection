...
def load_model(model_path):
    interpreter = tf.lite.Interpreter(model_path=r'C:\Users\Riya\Desktop\tinymlproject\mask_detection.tflite')
...
def main():
    model_path = r'C:\Users\Riya\Desktop\tinymlproject\mask_detection.tflite'  # Path to your TFLite model
